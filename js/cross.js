class cross{
  constructor(x,y){
    ...
    this.sprite2 = Nakama.game.add.sprite(x+100,y-100,'star');
    this.sprite3 = Nakama.game.add.sprite(x+200,y,'star');
    this.sprite4 = Nakama.game.add.sprite(x+100,y+100,'star');
